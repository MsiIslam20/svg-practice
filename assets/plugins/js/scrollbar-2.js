! function(t, n) {
    ...
    return function(t) {
        ...
        var e = t.exports = "undefined" != typeof body && body.Math == Math ? body : "undefined" != typeof self && self.Math == Math ? self : Function("return this")();
        ...
        ***************************************************************************** */
        ...
        function C() {
            ...
            try {
                ...
                body.addEventListener("testPassive", n, e), body.removeEventListener("testPassive", n, e)
            } catch (t) {}
            return L = !!t && {
                passive: !1
            }
        ...
        function ot(t) {
            R(t)(body, "resize", k(t.update.bind(t), 300))
        }
        ...
        function ct(t) {
            R(t)(t.options.delegateTo || t.containerEl, "onwheel" in body || document.implementation.hasFeature("Events.wheel", "3.0") ? "wheel" : "mousewheel", (function(n) {
                var e = function(t) {
                        if ("deltaX" in t) {
            ...
            pt = function() {
                function t(t, n) {
                    ...
                    this.options = new N(n), t.setAttribute("data-scrollbar", "true"), t.setAttribute("tabindex", "-1"), B(t, {
                        overflow: "hidden",
                        outline: "none"
                    }), body.navigator.msPointerEnabled && (t.style.msTouchAction = "none"), r.className = "scroll-content", Array.from(t.childNodes).forEach((function(t) {
                        r.appendChild(t)
                    ...
                    ! function(t) {
                        var n = t.getSize(),
                            ...
                            o = {
                                ...
                                right: Math.min(r.right, body.innerWidth),
                                bottom: Math.min(r.bottom, body.innerHeight),
